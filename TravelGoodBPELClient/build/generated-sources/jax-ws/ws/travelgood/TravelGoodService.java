 ...
 * 
 */
@WebServiceClient(name = "travelGoodService", targetNamespace = "http://travelGood.ws", wsdlLocation = "http://localhost:9080/service?wsdl")
    ...
    extends Service
{
     ...
     */
    @WebEndpoint(name = "travelGoodPortTypeBindingPort")
    public TravelGoodPortType getTravelGoodPortTypeBindingPort() {
        return super.getPort(new QName("http://travelGood.ws", "travelGoodPortTypeBindingPort"), TravelGoodPortType.class);
    }
     ...
     */
    @WebEndpoint(name = "travelGoodPortTypeBindingPort")
    public TravelGoodPortType getTravelGoodPortTypeBindingPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://travelGood.ws", "travelGoodPortTypeBindingPort"), TravelGoodPortType.class, features);
    }
