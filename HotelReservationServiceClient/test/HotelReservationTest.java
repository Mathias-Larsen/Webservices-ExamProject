...
public class HotelReservationTest {
    ...
    public void testBookHotel() {
        try {
            boolean toReturn = bookHotel(12345,creditcard,true);
    ...
    private static boolean bookHotel(int bookingNumber, dk.dtu.imm.fastmoney.types.CreditCardInfoType creditCardInfo, boolean creditCardGuaranteeRequired) throws BookHotelFaultMessage {
        ...
        return port.bookHotel(bookingNumber, creditCardInfo, creditCardGuaranteeRequired);
    }
